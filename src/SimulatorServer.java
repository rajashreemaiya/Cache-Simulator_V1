...
public class SimulatorServer {
	...
	public synchronized static int searchMemory(int clientNum, int reqData,
			SimulatorLogger logFile, SimulatorTickCounts mytickCount, String strategy) {
	...
	private synchronized static void writeToServer(int newValue, String whatStrategy) {
	...
	private synchronized static void writeToServerLRU(int newValue, int accCounter, ArrayList<Integer> indexArr) {
		synchronized (serverMemory) {
